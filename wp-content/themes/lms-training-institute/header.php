...
<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'lms-training-institute' ); ?></a>

<?php if ( get_theme_mod('lms_education_site_loader', false) == true ) : ?>
	<div class="cssloader">
    	<div class="sh1"></div>
    	<div class="sh2"></div>
    	<h1 class="lt"><?php esc_html_e( 'loading',  'lms-training-institute' ); ?></h1>
    </div>
<?php endif; ?>
			...
			<div class="row">
				<div class="col-lg-7 col-md-6 align-self-center text-md-left text-center">
					<?php if ( get_theme_mod('lms_education_phone_number') ) : ?>
				    	<span class="mr-3"><span class="dashicons dashicons-<?php echo esc_attr( $icon1 ); ?>"></span><a href="callto:<?php echo esc_html(get_theme_mod('lms_education_phone_number','')); ?>"><?php echo esc_html(get_theme_mod('lms_education_phone_number','')); ?></a></span>
				  	<?php endif; ?>
				...
				<div class="row">
					...
					<div class="col-lg-7 col-md-10 col-sm-8 col-12 align-self-center">
						<button class="menu-toggle my-2 p-2" aria-controls="top-menu" aria-expanded="false" type="button">
							<span aria-hidden="true"><?php esc_html_e( 'Menu', 'lms-training-institute' ); ?></span>
						</button>
					...
					<div class="col-lg-1 col-md-1 col-sm-2 col-6 text-center align-self-center">
						<?php if ( class_exists( 'Woocommerce' ) ) {?>
							<a class="cart-customlocation" href="<?php if(function_exists('wc_get_cart_url')){ echo esc_url(wc_get_cart_url()); } ?>" title="<?php esc_attr_e( 'View Shopping Cart','lms-training-institute' ); ?>"><i class="fas fa-shopping-cart"></i><p class="cart-item-box"> <?php echo esc_html(wp_kses_data( WC()->cart->get_cart_contents_count() ));?></p></a>
						<?php }?>
					</div>
				</div>
			</div>
